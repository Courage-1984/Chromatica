// Main entry point for Chromatica Color Search Engine
import * as ColorManagement from './modules/colorManagement.js';
...
import * as Collage from './modules/collage.js';

console.log('Loading Chromatica JavaScript...');

// Expose necessary functions to global scope
window.addColor = ColorManagement.addColor;
window.removeColor = ColorManagement.removeColor;
window.updateColors = ColorManagement.updateColors;
window.updateWeights = ColorManagement.updateWeights;
window.updateColorPalette = ColorManagement.updateColorPalette;

window.showError = UIUtils.showError;
window.showSuccess = UIUtils.showSuccess;
window.showImageInModal = UIUtils.showImageInModal;

window.performSearch = Search.performSearch;
window.updateSearchResults = Results.updateSearchResults;
window.updateVisualization = Visualization.updateVisualization;
window.generateHistogramVisualization = Visualization.generateHistogramVisualization;

window.generateResultsCollage = Collage.generateResultsCollage;
window.downloadCollage = Collage.downloadCollage;
